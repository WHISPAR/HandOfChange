    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-blue-700 via-blue-600 to-blue-500 text-white px-6 py-4 shadow-lg">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-6">
          <a href="#activities" className="hover:text-blue-200 font-medium transition duration-200">
            Activities
          </a>
          <a href="#mission" className="hover:text-blue-200 font-medium transition duration-200">
            Mission
          </a>
          <a href="#about" className="hover:text-blue-200 font-medium transition duration-200">
            About Us
          </a>
          <button
